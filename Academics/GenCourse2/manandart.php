...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_SESSION['email'])) {
    ...
    header("Location: manandart.php"); // รีเฟรชหน้า
    exit();
}
?>
...
<title>MAN AND ART มนุษย์กับศิลปะ</title>
...
<div class="page-header">
    ...
    <h1>MAN AND ART มนุษย์กับศิลปะ</h1>
</div>
...
<div class="detail-container">
    <div class="detail-card">
        ...
        <div class="detail-content">
            <p><b>MAN AND ART มนุษย์กับศิลปะ</b></p>
            <p>หลักสูตรไทย : 90642151</p>
            <p>Inter Program : 96642151</p>
