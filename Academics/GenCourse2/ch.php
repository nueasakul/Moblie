...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_SESSION['email'])) {
    ...
    header("Location: ch.php"); // รีเฟรชหน้า
    exit();
}
?>
...
<title>CHINESE FANDOM ภาษาจีนฉบับแฟนด้อม</title>
...
<div class="page-header">
    ...
    <h1>CHINESE FANDOM ภาษาจีนฉบับแฟนด้อม</h1>
</div>
...
<div class="detail-container">
    <div class="detail-card">
        ...
        <div class="detail-content">
            <p><b>CHINESE FANDOM ภาษาจีนฉบับแฟนด้อม</b></p>
            <p>หลักสูตรไทย : 90644058</p>
            <p>Inter Program : 96644058</p>
            <p>กลุ่มทักษะ : Language and Communication Skills</p>
