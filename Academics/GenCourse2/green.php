...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_SESSION['email'])) {
    ...
    header("Location: green.php"); // รีเฟรชหน้า
    exit();
}
?>
...
<title>GREEN TECHNOLOGY AND ALTERNATIVE ENERGY เทคโนโลยีสีเขียวและพลังงานทดแทน</title>
...
<div class="page-header">
    ...
    <h1>GREEN TECHNOLOGY AND ALTERNATIVE ENERGY <br>เทคโนโลยีสีเขียวและพลังงานทดแทน</h1>
</div>
...
<div class="detail-container">
    <div class="detail-card">
        ...
        <div class="detail-content">
            <p><b>GREEN TECHNOLOGY AND ALTERNATIVE ENERGY เทคโนโลยีสีเขียวและพลังงานทดแทน</b></p>
            <p>หลักสูตรไทย : 90642115</p>
            <p>Inter Program : 96642115</p>
            <p>กลุ่มทักษะ : Personal and Professional Skills</p>
            <p>หน่วยกิต : 3(3-0-6)</p>
            <br>
        </div>
    </div>
