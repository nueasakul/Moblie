...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_SESSION['email'])) {
    ...
    header("Location: py.php"); // รีเฟรชหน้า
    exit();
}
?>
...
<head>
    ...
    <title>Coding with Python เขียนโค้ดด้วยไพทอน</title>
...
<body>
    ...
    <div class="page-header">
        ...
        <h1>Coding with Python เขียนโค้ดด้วยไพทอน</h1>
    </div>
    ...
    <div class="detail-container">
        <div class="detail-card">
            ...
            <div class="detail-content">
                <p><b>Coding with Python เขียนโค้ดด้วยไพทอน</b></p>
                <p>หมวดวิชา : กลุ่มทักษะด้านบุคคลและทักษะส่งเสริมวิชาชีพ</p>
                <p>เกรดที่ได้รับ : A,B,C,D,F</p>
