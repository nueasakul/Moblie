...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_SESSION['email'])) {
    ...
    header("Location: era.php"); // รีเฟรชหน้า
    exit();
}
?>
...
<title>Digital Era Finance and Investment การเงินและการลงทุนในยุคดิจิทัล</title>
...
<div class="page-header">
    ...
    <h1>Digital Era Finance and Investment</h1>
    <h1>การเงินและการลงทุนในยุคดิจิทัล</h1>
</div>
...
<div class="detail-container">
    <div class="detail-card">
        ...
        <div class="detail-content">
            <p><b>Digital Era Finance and Investment การเงินและการลงทุนในยุคดิจิทัล</b></p>
            <p>หมวดวิชา : กลุ่มทักษะด้านการจัดการและภาวะความเป็นผู้นำ</p>
