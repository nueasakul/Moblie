...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_SESSION['email'])) {
    ...
    header("Location: fun.php"); // รีเฟรชหน้า
    exit();
}
?>
...
<title>Fun with Coding สนุกกับการเขียนโค้ด</title>
...
<div class="page-header">
    ...
    <h1>Fun with Coding สนุกกับการเขียนโค้ด</h1>
</div>
...
<div class="detail-container">
    <div class="detail-card">
        ...
        <div class="detail-content">
            <p><b>Fun with Coding สนุกกับการเขียนโค้ด</b></p>
