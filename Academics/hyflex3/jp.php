...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_SESSION['email'])) {
    ...
    header("Location: jp.php"); // รีเฟรชหน้า
    exit();
}
?>
...
<title>Foundation Japanese ภาษาญี่ปุ่นพื้นฐาน</title>
...
<div class="page-header">
    ...
    <h1>Foundation Japanese ภาษาญี่ปุ่นพื้นฐาน</h1>
</div>
...
<div class="detail-container">
    <div class="detail-card">
        ...
        <div class="detail-content">
            <p><b>Foundation Japanese ภาษาญี่ปุ่นพื้นฐาน</b></p>
